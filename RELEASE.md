...
3. **Commit, tag, push, and release**
   ...
   gh release create v1.1.2 --title "v1.1.2" --notes "Release notes here" dist/Valoryx-Setup-1.1.2.exe dist/latest.yml
   ```
...
- Replace `1.1.2` with the actual version number each release.
